...
class Frequency(Tmachinery):
    """The frequency convertor data transmission protocol is based on the Broadcast Announce Message (BAM) protocol
    according to SAE J1939/21\n The difference is in the transmission speed of 125kBd and bypassing the time lag
    between packets. All CAN messages are 29-bit with 8 byte length.\n The first message with ID=0x1C, 0xECFF,
    0x91 is a header (TP.CM) containing the shearer data ID=0x1012, length 74\n Other messages with ID=0x1C, 0xEBFF,
    0x91 are data (TP.DT) and contain the following structure by 7 bytes groups: """
    data_status = 0  # Reg[0], uchar, 0[bit] - if 1:data valid, 1[bit] - if 1:data simulation
    software_version = ""  # Reg[2,3] HL, uchar, 50.17
    ...
    error_can_mz = 0  # Reg[32:2]
    error_can_mdm = 0  # Reg[32:3]
    error_can_rs = 0  # Reg[32:4]
    error_can_rele0 = 0  # Reg[32:5]
    error_can_can = 0  # Reg[32:6]
    error_mdm_temperature = 0  # Reg[32:7]
    error_2 = 0  # Reg[33]
    error_rs485_mf = 0  # Reg[33:0]
    error_fail_parametry = 0  # Reg[33:1]
    error_can_tportw = 0  # Reg[33:2]
    error_f1_mos = 0  # Reg[33:7]
    error_3 = 0  # Reg[34]
    error_f1_eno = 0  # Reg[34:0]
    error_f1_zkrat = 0  # Reg[34:1]
    error_f1_overhead = 0  # Reg[34:2]
    error_f1_fail_phase = 0  # Reg[34:3]
    error_f1_overheat = 0  # Reg[34:4]
    error_f1_fail_gnd = 0  # Reg[34:5]
    error_f1_fail_bru = 0  # Reg[34:6]
    error_4 = 0  # Reg[35]
    error_fe5_rvm_brzda = 0  # Reg[35:0]
    error_fe5_fe6_overload = 0  # Reg[35:1]
    error_ris_fail_bru_42v = 0  # Reg[35:2]
    error_ris_fail_bru_pv5_6 = 0  # Reg[35:3]
    error_5 = 0  # Reg[36] UNUSED
    error_6 = 0  # Reg[37] UNUSED
    error_7 = 0  # Reg[38] UNUSED
    error_8 = 0  # Reg[39] UNUSED
    errorFreelop_1 = 0  # Reg[40]
    Freelop_rezervacia = 0  # Reg[40:0]
    Freelop_provoz = 0  # Reg[40:1]
    Freelop_enter = 0  # Reg[40:2]
    Freelop_block_vozbud = 0  # Reg[40:3]
    Freelop_limit_amper = 0  # Reg[40:4]
    Freelop_contact_XS1 = 0  # Reg[40:5]
    Freelop_generator_mode = 0  # Reg[40:6]
    errorFreelop_2 = 0  # Reg[41]
    Freelop_external_fail = 0  # Reg[41:0]
    Freelop_high_amper = 0  # Reg[41:1]
    Freelop_high_temperature_air = 0  # Reg[41:2]
    Freelop_low_temperature_air = 0  # Reg[41:3]
    Freelop_high_temperature_holod = 0  # Reg[41:4]
    Freelop_low_temperature_holod = 0  # Reg[41:5]
    Freelop_open_current_circuit = 0  # Reg[41:6]
    errorFreelop_3 = 0  # Reg[42]
    Freelop_capacitance_voltage_drop = 0  # Reg[42:0]
    Freelop_overvoltage = 0  # Reg[42:1]
    Freelop_stop_generation_mode = 0  # Reg[42:2]
    Freelop_fail_button = 0  # Reg[42:3]
    Freelop_off_output_contact = 0  # Reg[42:4]
    Freelop_fail_eeprom = 0  # Reg[42:5]
    errorFreelop_4 = 0  # Reg[43]
    Freelop_peak_current = 0  # Reg[43:0]
    Freelop_fail_cpu = 0  # Reg[43:1]
    Freelop_overvoltage_5v = 0  # Reg[43:2]
    Freelop_drop_voltage = 0  # Reg[43:3]
    Freelop_off_input_contact = 0  # Reg[43:4]
    Freelop_main_voltage_drop = 0  # Reg[43:5]
    Freelop_fail_ram = 0  # Reg[43:6]
    errorFdrive = ""  # Reg[44-47] UNUSED
    mfk_status_1 = 0  # Reg[48]
    mfk_mvv_12v = 0  # Reg[48:0]
    mfk_mvv_modem = 0  # Reg[48:1]
    mfk_mvv_24v_zk6 = 0  # Reg[48:2]
    mfk_mvv_1zk6 = 0  # Reg[48:3]
    mfk_mvv_2zk6 = 0  # Reg[48:4]
    mfk_status_2 = 0  # Reg[49]
    mfk_mvv_42v_ext = 0  # Reg[49:0]
    mfk_mvv_mode = 0  # Reg[49:1]
    mfk_mvv_snd = 0  # Reg[49:2]
    mfk_mvv_block_auto_zk6 = 0  # Reg[49:3]
    mfk_mvv_block_konv_zk6 = 0  # Reg[49:4]
    mfk_mvv_move_left = 0  # Reg[49:5]
    mfk_mvv_move_right = 0  # Reg[49:6]
    mfk_mvv_water_flow_sensor = 0  # Reg[49:7]
    mfk_status_3 = 0  # Reg[50]
    mfk_mvv_freelop_ok = 0  # Reg[50:0]
    mfk_mvv_freelop_k1 = 0  # Reg[50:1]
    mfk_mvv_freelop_k2 = 0  # Reg[50:2]
    mfk_mvv_freelop_overheat = 0  # Reg[50:3]
    mfk_mvv_k101 = 0  # Reg[50:4]
    mfk_mvv_ris_leak = 0  # Reg[50:5]
    mfk_mvv_power_42v = 0  # Reg[50:6]
    mfk_mvv_ris_leak_pv5_6 = 0  # Reg[50:7]
    mfk_status_4 = 0  # Reg[51]
    mfk_mvv_diag_shearer = 0  # Reg[51:0]
    mfk_mvv_start_shearer = 0  # Reg[51:1]
    mfk_mvv_direction_right = 0  # Reg[51:2]
    mfk_mvv_direction_left = 0  # Reg[51:3]
    mfk_mvv_speed_down = 0  # Reg[51:4]
    mfk_mvv_speed_up = 0  # Reg[51:5]
    mfk_mvv_feedback_start_k162 = 0  # Reg[51:6]
    mfk_mvv_feedback_start_k152 = 0  # Reg[51:7]
    mfk_status_5 = 0  # Reg[52]
    mfk_can_rele_24v = 0  # Reg[52:0]
    mfk_can_rele_k523_2 = 0  # Reg[52:1]
    mfk_can_alarm_stop = 0  # Reg[52:2]
    mfk_can_work_konv = 0  # Reg[52:3]
    mfk_can_diag_shearer = 0  # Reg[52:4]
    mfk_can_start_shearer = 0  # Reg[52:5]
    mfk_can_feedback_start_shearer = 0  # Reg[52:6]
    mfk_can_rele_k523_1 = 0  # Reg[52:7]
    mfk_status_6 = 0  # Reg[53]
    mfk_can_rele_k1 = 0  # Reg[53:0]
    mfk_can_rele_k2 = 0  # Reg[53:1]
    mfk_can_rele_k3 = 0  # Reg[53:2]
    mfk_can_rele_k4 = 0  # Reg[53:3]
    mfk_can_rele_k5 = 0  # Reg[53:4]
    mfk_can_rele_k6 = 0  # Reg[53:5]
    mfk_can_rele_k7 = 0  # Reg[53:6]
    mfk_can_rele_k8 = 0  # Reg[53:7]
    mfk_status_7 = 0  # Reg[54]
    mfk_shearer_modem_allow = 0  # Reg[54:0]
    mfk_shearer_modem_input = 0  # Reg[54:1]
    mfk_status_8 = 0  # Reg[55]
    mfk_perfomance_sno = 0  # Reg[55:6]
    mfk_perfomance_TLM = 0  # Reg[55:7]
    ...
    def mfk400(self, data):
        ...
        self.software_version = str(data[19]) + "." + str(data[20])
...
class Shearer(Tmachinery):
    """The shearer data transmission protocol is based on the Broadcast Announce Message (BAM) protocol according to
    SAE J1939/21\n The difference is in the transmission speed of 125kBd and bypassing the time lag between packets.
    All CAN messages are 29-bit with 8 byte length.\n The first message with ID=0x1C, 0xECFF, 0x91 is a header (
    TP.CM) containing the shearer data ID=0x1010, length 86 or 92byte (according to SW version)\n Other messages with
    ID=0x1C, 0xEBFF, 0x91 are data (TP.DT) and contain the following structure by 7 bytes groups """
    data_status = 0  # Reg[0], uchar, 0 - data valid, 1 - data simulation
    software_version = ""  # Reg[2,3] HL, uchar, 7.11
    ...
    current_speed = 0.0  # Reg[19,20], uint, 0-250, 0.1m/min
    current_speed_status = 0  # Reg[21], Sstat, 0-15
    ...
    sensor_direction = 0  # Reg[32], uchar
    sensor_direction_status_sensor_speed = 0  # Reg[32:0]
    sensor_direction_status_sensor_direction = 0  # Reg[32:1]
    sensor_direction_error_communicate = 0  # Reg[32:2]
    sensor_direction_enable = 0  # Reg[32:3]
    sensor_direction_move_shearer_left = 0  # Reg[32:4]
    sensor_direction_move_shearer_right = 0  # Reg[32:5]
    ...
    position = ""  # Reg[43, 44, 45, 46], ulong
    ...
    def shearer_data(self, data):
        ...
        self.current_speed = ((data[46] << 8) + data[47]) / 10
        self.current_speed_status = data[53]
        ...
        self.management_command_Rplus = 0  # Reg[29:0]
        self.management_command_Rminus = 0  # Reg[29:1]
        self.management_command_SML = 0  # Reg[29:2]
        self.management_command_SMP = 0  # Reg[29:3]
        self.management_command_stop_konv = 0  # Reg[29:4]
        self.management_command_shearer_on = 0  # Reg[29:5]
        self.management_command_stop_auton = 0  # Reg[29:6]
        self.management_command_start_button = 0  # Reg[29:7]
        self.electro_hydro_valve = data[67]
        self.electro_hydro_valve_brz2 = 0  # Reg[30:0]
        self.electro_hydro_valve_spol = 0  # Reg[30:1]
        self.electro_hydro_valve_vf1 = 0  # Reg[30:2]
        self.electro_hydro_valve_vf2 = 0  # Reg[30:3]
        self.electro_hydro_valve_rpn = 0  # Reg[30:4]
        self.electro_hydro_valve_rpd = 0  # Reg[30:5]
        self.electro_hydro_valve_rln = 0  # Reg[30:6]
        self.electro_hydro_valve_rld = 0  # Reg[30:7]
        self.management_drobilka = data[68]
        self.management_drobilka_dn = 0  # Reg[31:0]
        self.management_drobilka_dd = 0  # Reg[31:1]
        self.management_drobilka_kn = 0  # Reg[31:2]
        self.management_drobilka_kd = 0  # Reg[31:3]
        self.management_drobilka_spp = 0  # Reg[31:4]
        self.management_drobilka_spl = 0  # Reg[31:5]
        self.management_drobilka_sll = 0  # Reg[31:6]
        self.management_drobilka_slp = 0  # Reg[31:7]
        self.sensor_direction = data[69]
        self.sensor_direction_status_sensor_speed = 0  # Reg[32:0]
        self.sensor_direction_status_sensor_direction = 0  # Reg[32:1]
        self.sensor_direction_error_communicate = 0  # Reg[32:2]
        self.sensor_direction_enable = 0  # Reg[32:3]
        self.sensor_direction_move_shearer_left = 0  # Reg[32:4]
        self.sensor_direction_move_shearer_right = 0  # Reg[32:5]
        self.sensor_pologenie = data[70]
        self.sensor_pologenie_status_sensor_1 = 0  # Reg[33:0]
        self.sensor_pologenie_status_sensor_2 = 0  # Reg[33:1]
        self.sensor_pologenie_error_communicate = 0  # Reg[33:2]
        self.sensor_pologenie_enable = 0  # Reg[33:3]
        self.sensor_pologenie_activity_memory = 0  # Reg[33:4]
        self.sensor_pologenie_extended_status = 0  # Reg[33:5]
        self.sensor_pologenie_concentrator = 0  # Reg[33:7]
        ...
        self.error_overload_m1 = 0  # Reg[60:0]
        self.error_overload_m2 = 0  # Reg[60:1]
        self.error_overload_m3 = 0  # Reg[60:2]
        self.error_overload_m4 = 0  # Reg[60:3]
        self.error_overload_m5 = 0  # Reg[60:4]
        self.error_overload_m6 = 0  # Reg[60:5]
        self.error_overheat_m1 = 0  # Reg[60:6]
        self.error_overheat_m2 = 0  # Reg[60:7]
        self.error_2 = data[118]
        self.error_overheat_m3 = 0  # Reg[61:0]
        self.error_overheat_m4 = 0  # Reg[61:1]
        self.error_overheat_m5 = 0  # Reg[61:2]
        self.error_2_overheat_m6 = 0  # Reg[61:3] UNUSED
        self.error_leak_m1 = 0  # Reg[61:4]
        self.error_leak_m2 = 0  # Reg[61:5]
        self.error_leak_m5 = 0  # Reg[61:6]
        self.error_leak_m6 = 0  # Reg[61:7] UNUSED
        self.error_3 = data[119]
        self.error_cv1 = 0  # Reg[62:0]
        self.error_cv2 = 0  # Reg[62:1]
        self.error_sensor_oil_level = 0  # Reg[62:2]
        self.error_sensor_dirty_suction_filter = 0  # Reg[62:3]
        self.error_sensor_pressure_filter = 0  # Reg[62:4]
        self.error_sensor_drain_filter = 0  # Reg[62:5]
        self.error_sensor_CH4_TMRK = 0  # Reg[62:6]
        self.error_brake_failure = 0  # Reg[62:7] UNUSED
        self.error_4 = data[125]
        self.error_fail_management = 0  # Reg[63:0]
        self.error_sensor_amper_lem1 = 0  # Reg[63:1]
        self.error_sensor_amper_lem2 = 0  # Reg[63:2]
        self.error_sensor_amper_lem3 = 0  # Reg[63:3]
        self.error_sensor_amper_lem4 = 0  # Reg[63:4]
        self.error_sensor_amper_lem5 = 0  # Reg[63:5]
        self.error_sensor_amper_lem6 = 0  # Reg[63:6] UNUSED
        self.error_fail_module_can11_vana = 0  # Reg[63:7]
        self.error_5 = data[126]
        self.error_fail_module_mcv1 = 0  # Reg[64:0]
        self.error_fail_module_mcp1 = 0  # Reg[64:1]
        self.error_fail_module_mcd1 = 0  # Reg[64:2]
        self.error_fail_module_mco1 = 0  # Reg[64:3]
        self.error_fail_module_mco2 = 0  # Reg[64:4]
        self.error_fail_module_mco3 = 0  # Reg[64:5]
        self.error_fail_module_mco4 = 0  # Reg[64:6]
        self.error_fail_module_mco5 = 0  # Reg[64:7]
        self.error_6 = data[127]
        self.error_fail_module_mco6 = 0  # Reg[65:0] UNUSED
        self.error_fail_module_memory = 0  # Reg[65:1]
        self.error_command_stop_from_remote_control_transmission = 0  # Reg[65:2]
        self.error_fail_module_can_remote_control_transmission = 0  # Reg[65:3]
        self.error_parameter_failure = 0  # Reg[65:4]
        self.error_button_stop = 0  # Reg[65:5]
        self.error_uninhibited = 0  # Reg[65:6]
        self.error_stop_overload_regulation_m1_m2 = 0  # Reg[65:7]
        self.error_7 = data[128]
        self.error_no_direction = 0  # Reg[66:0]
        self.error_shearer_not_accelerate_overload_regulation_m3_m4 = 0  # Reg[66:1]
        self.error_off_from_pv5 = 0  # Reg[66:2]
        self.error_off_from_pv4 = 0  # Reg[66:3]
        self.error_fail_modem_mdm = 0  # Reg[66:4]
        self.error_overheat_modem_mdm = 0  # Reg[66:5]
        self.error_off_m1_from_regulation = 0  # Reg[66:6]
        self.error_off_m2_from_regulation = 0  # Reg[66:7]
        self.error_8 = data[129]
        self.error_feed_block = 0  # Reg[67:0]
        self.error_9 = data[130]
        self.error_fail_contactor_m1 = 0  # Reg[68:0]
        self.error_fail_contactor_m2 = 0  # Reg[68:1]
        self.error_fail_contactor_m5 = 0  # Reg[68:2]
        self.error_fail_contactor_m6 = 0  # Reg[68:3] UNUSED
        self.error_10 = data[131]
        self.error_no_supply_current = 0  # Reg[69:4]
        self.error_short_stop = 0  # Reg[69:5]
        self.error_bad_feed_direction = 0  # Reg[69:6]
        self.error_not_power_24V_ACV = 0  # Reg[69:7]
        self.error_11 = data[137]
        self.error_fail_sensor_amper_1 = 0  # Reg[70:0]
        self.error_fail_sensor_amper_2 = 0  # Reg[70:1]
        self.error_fail_sensor_amper_3 = 0  # Reg[70:2]
        self.error_fail_sensor_amper_4 = 0  # Reg[70:3]
        self.error_fail_sensor_amper_5 = 0  # Reg[70:4]
        self.error_fail_sensor_amper_6 = 0  # Reg[70:5] UNUSED
        self.error_no_variable_cef_mco1 = 0  # Reg[70:6]
        self.error_no_variable_cef_mco2 = 0  # Reg[70:7]
        self.error_12 = data[138]
        self.error_no_variable_cef_mco3 = 0  # Reg[71:0]
        self.error_no_variable_cef_mco4 = 0  # Reg[71:1]
        self.error_no_variable_cef_mco5 = 0  # Reg[71:2]
        self.error_no_variable_cef_mco6 = 0  # Reg[71:3] UNUSED
        self.error_not_voltage230v_mco1 = 0  # Reg[71:4]
        self.error_not_voltage230v_mco2 = 0  # Reg[71:5]
        self.error_not_voltage230v_mco5 = 0  # Reg[71:6]
        self.error_not_voltage230v_mco6 = 0  # Reg[71:7]
        self.status_1 = data[139]
        self.status_start_m1 = 0  # Reg[72:0]
        self.status_start_m2 = 0  # Reg[72:1]
        self.status_start_m5 = 0  # Reg[72:2]
        self.status_start_m6 = 0  # Reg[72:3]
        self.status_m1_failure_is_over = 0  # Reg[72:4]
        self.status_m2_failure_is_over = 0  # Reg[72:5]
        self.status_m5_failure_is_over = 0  # Reg[72:6]
        self.status_m6_failure_is_over = 0  # Reg[72:7]
        self.status_2 = data[140]
        self.status_contactor_1_on = 0  # Reg[73:0]
        self.status_contactor_2_on = 0  # Reg[73:1]
        self.status_contactor_3_on = 0  # Reg[73:2]
        self.status_short_circuit_m1 = 0  # Reg[73:3]
        self.status_short_circuit_m2 = 0  # Reg[73:4]
        self.status_short_circuit_m5 = 0  # Reg[73:5]
        self.status_button_stop_left = 0  # Reg[73:6]
        self.status_button_stop_right = 0  # Reg[73:7]
        self.status_3 = data[141]
        self.status_m1_off_signal_stop = 0  # Reg[74:0]
        self.status_m2_off_signal_stop = 0  # Reg[74:1]
        self.status_m5_off_signal_stop = 0  # Reg[74:2]
        self.status_lower_brake_pressure_sensor_50bar = 0  # Reg[74:3]
        self.status_upper_brake_pressure_sensor_100bar = 0  # Reg[74:4]
        self.status_not_power_can12_24v = 0  # Reg[74:5]
        self.status_4 = data[142]
        self.status_module_management_mco6_allow = 0  # Reg[75:0]
        self.status_module_converter_mcp_allow = 0  # Reg[75:1]
        self.status_module_valve_mcv_allow = 0  # Reg[75:2]
        self.status_block_move_shearer_pv5 = 0  # Reg[75:5]
        self.status_block_start_shearer_pv4 = 0  # Reg[75:6]
        self.status_support_start_button_shearer = 0  # Reg[75:7]
